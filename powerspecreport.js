// Este modulo de Node recibe como parametro un string URL con el link del archivo xls a convertir
// posteriormente lo descarga y descarga un archivo xls con los datos base a comparar
// posteriormente convierte el contenido xls a json y lo compara, arrojando los resultados 
// diferentes; al final el codigo elimina los archivos descargados.
// Se usa timeouts para sincronizar los pasos.
...
const download1 = () => {
    let urlPlantilla = "https://storage.googleapis.com/.../PlatillaParametros.xls";
    let optionsPlant = {
        directory: "./temp",
